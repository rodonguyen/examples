...
int main()
{
  ...
  addRecord(time_01, mem_usage_finished_training, "Trained");
  ...
  time_01 = std::chrono::high_resolution_clock::now();
  mem_usage_01 = getMemUsage();
  addRecord(time_01, mem_usage_01, "Predicted train data");
  ...
  time_01 = std::chrono::high_resolution_clock::now();
  mem_usage_01 = getMemUsage();
  addRecord(time_01, mem_usage_01, "Predicted val data");
